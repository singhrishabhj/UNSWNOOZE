...
function AnimatedDigit({ digit, style }: { digit: string; style?: any }) {
  ...
  return (
    <Animated.Text style={[style, { transform: [{ translateY: slideAnim }] }]}>
      {digit}
    </Animated.Text>
  );
}
    ...
    <View style={styles.container}>
      ...
      <View style={styles.timeRow}>
        <View style={styles.digitGroup}>
          <AnimatedDigit
            digit={displayHours[0]}
            style={[styles.digit, { fontSize, color: textColor }]}
          />
          <AnimatedDigit
            digit={displayHours[1]}
            style={[styles.digit, { fontSize, color: textColor }]}
          />
        </View>
        <Text
          style={[
            styles.colon,
            { fontSize: fontSize * 0.8, color: Colors.primary },
          ]}
        >
          :
        </Text>
